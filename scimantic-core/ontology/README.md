...
This directory contains the formal ontology definition for Scimantic.

## Files

- **scimantic.ttl**: The Scimantic ontology in Turtle format
...
3. **Minimal Extension**: Only define Scimantic-specific concepts not in existing ontologies
...
For uncertainty quantification, Scimantic recommends:
...
rapper -i turtle -o ntriples scimantic.ttl

# Using Protégé
# Open scimantic.ttl in Protégé and run the reasoner
```

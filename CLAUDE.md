...
- **Source of Truth**: `schema/scimantic.yaml` (LinkML schema) and specification docs
...
1. **Review Specification**:
   - Read `schema/scimantic.yaml` for the activity definition
...
3. **Outer Loop - Implement SHACL Shapes**:
   - Update `schema/scimantic.yaml` to add constraints
...
- Source of truth: `schema/scimantic.yaml` and specification docs
